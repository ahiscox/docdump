#!/usr/bin/env python
# This script is used to setup a development version
# of docdump in a virtualenv with (almost) all dependencies 
# automatically resolved, including a fresh github clone of
# the latest development or master repos. 
# Planned is a way to automatically configure the django
# and CherryPy environments. 
# 
